...
Investigate the relationship between happiness and two other variables in the data. Find a visualization that captures the relationship and write a paragraph to describe it. <br> <br>

Each member should study a different question (choose different variables to investigate). <br> <br>

Upload your answers and the data set to the repository. Discuss and refine answers as a team.
