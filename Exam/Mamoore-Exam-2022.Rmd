...
library(tidyverse)
# place the code for your answer here
#stores = read.csv("Story_County_Liquor_Sales_New.csv")
stores %>% mutate(City1 = City)
```
...
LiquorAmes20162 = LiquorAmes %>% filter(Year == 2016 & Month == 2)
LiquorAmes20163 = LiquorAmes %>% filter(Year == 2016 & Month == 3)
LiquorAmes20164 = LiquorAmes %>% filter(Year == 2016 & Month == 4)
LiquorAmes20165 = LiquorAmes %>% filter(Year == 2016 & Month == 5)
LiquorAmes20166 = LiquorAmes %>% filter(Year == 2016 & Month == 6)
LiquorAmes20167 = LiquorAmes %>% filter(Year == 2016 & Month == 7)
LiquorAmes20168 = LiquorAmes %>% filter(Year == 2016 & Month == 8)
LiquorAmes20169 = LiquorAmes %>% filter(Year == 2016 & Month == 9)
LiquorAmes201610 = LiquorAmes %>% filter(Year == 2016 & Month == 10)
LiquorAmes201611 = LiquorAmes %>% filter(Year == 2016 & Month == 11)
LiquorAmes201612 = LiquorAmes %>% filter(Year == 2016 & Month == 12)
